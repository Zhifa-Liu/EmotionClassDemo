...
public class NaiveBayesModel implements Serializable {
    ...
    public NaiveBayesModel(double posDocsSize, double negDocsSize, HashMap<String, Integer> posWordsMap, HashMap<String, Integer> negWordsMap, HashMap<String, BigDecimal> featureMap) {
